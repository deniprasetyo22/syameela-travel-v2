...
class UmrahController extends Controller
{
    public function index(Request $request)
    {
        ...
        $packages = $search ? Package::search($search)->where('type', 'Umroh')->latest()->paginate(9) : Package::where('type', 'Umroh')->latest()->paginate(9);
    ...
    public function dashboard(Request $request)
    {
        ...
        $packages = $search ? Package::search($search)->where('type', 'Umroh')->latest()->paginate(10) : Package::latest()->where('type', 'Umroh')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('pages.admin.umrah.create', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('umrah-dashboard')->with('success', 'Paket Umroh berhasil ditambahkan.');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pages.admin.umrah.show', ['data' => $data]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.admin.umrah.edit', ['data' => $data]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'name.required'    => 'Nama paket umroh tidak boleh kosong.',
            'name.max'         => 'Nama paket umroh tidak boleh lebih dari 255 karakter.',
            'name.unique'      => 'Nama paket umroh sudah digunakan.',
            'description.required' => 'Deskripsi paket umroh tidak boleh kosong.',
            'description.max'  => 'Deskripsi paket umroh tidak boleh lebih dari 5000 karakter.',
            'image.image'      => 'File yang diunggah bukan gambar.',
            'image.mimes'      => 'Format gambar harus JPEG, PNG, JPG, atau GIF.',
            'image.max'        => 'Ukuran gambar tidak boleh lebih dari 3MB.',
            'price.required'   => 'Harga paket umroh tidak boleh kosong.',
            'quota.required'   => 'Kuota paket umroh tidak boleh kosong.',
            ...
            'return_date.after_or_equal' => 'Tanggal kepulangan tidak boleh sebelum tanggal keberangkatan.',
            'facilities.required' => 'Fasilitas paket umroh tidak boleh kosong.',
        ]);
        ...
        return redirect()->route('umrah-dashboard')->with('success', 'Paket Umroh berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('umrah-dashboard')->with('success', 'Paket Umroh berhasil dihapus.');
    }
    ...
    public function submit(Request $request, $id)
    {
        ...
        $registrationNumber = 'Umroh-' . date('Y') . '-' . Str::upper(Str::random(5)) . '-' . $user->id;
    ...
    public function list(Request $request)
    {
        ...
        $packages = $search ? Package::search($search)->where('type', 'Umroh')->latest()->paginate(5) : Package::where('type', 'Umroh')->latest()->paginate(5);
