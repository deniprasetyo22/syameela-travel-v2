<x-layout :title="$data['title']">
    <div class="mx-4 mb-10 mt-20 grid gap-4 bg-white antialiased md:grid-cols-5 dark:bg-gray-900">
        <x-main-menu-user />
        <div class="overflow-x-auto rounded-md bg-gray-50 md:col-span-4">
            <h2 class="px-4 py-2 text-lg font-bold text-gray-900 dark:text-white">Detail Informasi Keberangkatan</h2>
            ...
            <div class="mx-4 space-y-2">
                <div class="w-full">
                    <form class="flex items-center gap-4" method="GET" action="{{ route('my-trips') }}">
                ...
                <div
                    class="shadow-xs relative overflow-x-auto rounded-lg border border-gray-200 bg-white dark:bg-gray-700">
