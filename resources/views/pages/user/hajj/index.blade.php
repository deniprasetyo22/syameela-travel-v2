    ...
    <div class="bg-gray-500 bg-cover bg-center bg-no-repeat bg-blend-multiply"
        ...
        <div
            ...
            <p class="mb-6 max-w-2xl font-light text-white md:text-lg lg:mb-8 lg:text-xl">
                Pilih paket Haji terbaik kami dengan fasilitas lengkap, bimbingan profesional, dan jadwal keberangkatan
                yang fleksibel. Ibadah lebih khusyuk bersama layanan terpercaya.
            </p>
        </div>
    </div>
