<x-layout :title="$data['title']">
    <div class="mx-auto my-20 max-w-screen-xl px-4">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('show-umrah-package', $data['package']->id) }}"
                                class="ms-1 hover:text-blue-600 md:ms-2 dark:hover:text-white">
                                Detail Paket
                            </a>
                        </div>
        ...
        {{-- Main Grid --}}
        <form action="{{ route('submit-umrah-package', $data['package']->id) }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="shadow-xs rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                        ...
                        {{-- <div>
                        <label for="bank"
                            class="mb-1 block text-sm font-medium text-gray-700 dark:text-white">Bank</label>
                        <select name="bank"
                            class="w-full rounded-lg border-gray-300 dark:bg-gray-700 dark:text-white">
                            <option disabled selected>Pilih Bank</option>
                            <option value="bca">Bank BRI</option>
                            <option value="bni">Bank BSI</option>
                            <option value="mandiri">Bank Mandiri</option>
                            <option value="mandiri">Bank Jago</option>
                        </select>
                    </div> --}}
                    </div>
                    ...
                    <div id="submit-button">
                        <div id="missing-message" class="mb-2 hidden">
                            <p class="text-xs text-red-500">Anda harus melengkapi semua dokumen wajib terlebih dahulu
                            </p>
                        </div>
