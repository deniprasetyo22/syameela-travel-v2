    ...
    <div class="mx-auto my-20 max-w-screen-xl px-4">
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div class="flex flex-col justify-between">
                ...
                <div class="mt-6">
                    @if (Auth::check())
                        <a href="{{ route('checkout-umrah-package', $data['package']->id) }}"
                    ...
                    @else
                        ...
                        <button type="button"
                            class="inline-block w-full cursor-not-allowed rounded-lg bg-gray-400 px-6 py-3 text-center text-sm font-medium text-white dark:bg-gray-600"
                            disabled>
                            Daftar Sekarang
                        </button>
                    @endif
