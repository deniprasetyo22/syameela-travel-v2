            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" required readonly
                        class="w-full cursor-not-allowed rounded-md border bg-gray-200 px-3 py-2 focus:ring focus:ring-blue-200"
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="mb-1 block text-sm font-medium">Konfirmasi
                        Password</label>
