            ...
            <div class="p-2">
                ...
                <div class="flex flex-col items-center justify-between py-2 md:flex-row md:space-x-4">
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center gap-4" method="GET" action="{{ route('gallery-dashboard') }}">
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($data['galleries'] as $gallery)
                                    @php
                                        $dropdownId = 'dropdown-' . $gallery->id;
                                        $buttonId = 'dropdown-button-' . $gallery->id;
                                        $modalId = 'delete-modal-' . $gallery->id;
                                    @endphp
                                    <tr class="odd:bg-white even:bg-gray-50 dark:border-gray-700">
                                        <td class="px-4 py-3">{{ $loop->iteration }}</td>
                                        <td class="px-4 py-3">{{ $gallery->title }}</td>
                                        <td class="px-4 py-3">{{ $gallery->type }}</td>
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="relative inline-block text-left">
                                                ...
                                                <div id="{{ $dropdownId }}"
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('show-gallery', $gallery->id) }}"
                                                                class="block px-4 py-2 hover:bg-gray-100">Lihat</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('edit-gallery', $gallery->id) }}"
                                            ...
                                            <div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
                                                ...
                                                <div class="p-4 text-center md:p-5">
                                                    ...
                                                    <h3
                                                        ...
                                                        Yakin ingin menghapus <b>{{ $gallery->gallery_name }}</b>?
                                                    </h3>
