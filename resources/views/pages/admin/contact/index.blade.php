            ...
            <div class="p-2">
                ...
                <div class="flex flex-col items-center justify-between py-2 md:flex-row md:space-x-4">
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center gap-4" method="GET" action="{{ route('contact-dashboard') }}">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" name="search" value="{{ request('search') }}"
                                    ...
                                    placeholder="Cari nama, email, nomor telepon atau pesan">
                            </div>
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($data['contacts'] as $contact)
                                    @php
                                        $dropdownId = 'dropdown-' . $contact->id;
                                        $buttonId = 'dropdown-button-' . $contact->id;
                                        $modalId = 'delete-modal-' . $contact->id;
                                    @endphp
                                    <tr class="odd:bg-white even:bg-gray-50 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ Str::limit($contact->message, 20, '...') }}</td>
                                        <td class="px-4 py-3">
                                            {{ $contact->created_at ? $contact->created_at->translatedFormat('j F Y, H:i:s') : '-' }}
                                        </td>
                                            ...
                                            <div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
                                                ...
                                                <div class="p-4 text-center md:p-5">
                                                    ...
                                                    <h3
                                                        ...
                                                        Yakin ingin menghapus <b>{{ $contact->full_name }}</b>?
                                                    </h3>
