            ...
            <div class="p-2">
                ...
                <div class="flex flex-col items-center justify-between py-2 md:flex-row md:space-x-4">
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center gap-4" method="GET" action="{{ route('testimonial-dashboard') }}">
                    ...
                    <table class="w-full min-w-[640px] text-left text-sm dark:text-gray-400">
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Testimoni</th>
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($data['testimonials'] as $testimonial)
                                    @php
                                        $dropdownId = 'dropdown-' . $testimonial->id;
                                        $buttonId = 'dropdown-button-' . $testimonial->id;
                                        $modalId = 'delete-modal-' . $testimonial->id;
                                    @endphp
                                    <tr class="odd:bg-white even:bg-gray-50 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            {{ $testimonial->created_at ? $testimonial->created_at->translatedFormat('j F Y, H:i:s') : '-' }}
                                        </td>
                                            ...
                                            <div class="relative inline-block text-left">
                                                ...
                                                <div id="{{ $dropdownId }}"
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('show-testimonial', $testimonial->id) }}"
                                            ...
                                            <div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
                                                ...
                                                <div class="p-4 text-center md:p-5">
                                                    ...
                                                    <h3
                                                        ...
                                                        Yakin ingin menghapus <b>{{ $testimonial->full_name }}</b>?
                                                    </h3>
