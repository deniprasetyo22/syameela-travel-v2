<x-layout :title="$data['title']">
    <div class="mb-4 h-auto p-4 pt-20 md:ml-64">
        <div class="rounded-lg border border-gray-200 bg-white p-2 dark:bg-gray-900">
            <div class="p-2">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Testimoni Baru</h2>
                ...
                <form action="{{ route('store-testimonial') }}" method="POST">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea rows="10" name="content" id="formTextArea">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
