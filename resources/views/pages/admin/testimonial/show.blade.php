<x-layout :title="$data['title']">
    <div class="mb-4 h-auto p-4 pt-20 md:ml-64">
        <div class="rounded-lg border border-gray-200 bg-white p-2 dark:bg-gray-900">
            <div class="p-2">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Detail Testimoni</h2>
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Tanggal
                            Dibuat</label>
                        <p class="rounded-lg bg-gray-100 p-2.5 text-sm text-gray-800 dark:bg-gray-700 dark:text-white">
                            {{ $data['testimonial']->created_at ? $data['testimonial']->created_at->translatedFormat('j F Y, H:i') : '-' }}
                        </p>
                    </div>

                    <div class="sm:col-span-2">
                        <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Testimoni</label>
                        <div
                            class="format max-w-full rounded-lg bg-gray-100 p-2.5 text-sm text-gray-800 dark:bg-gray-700 dark:text-white">
                ...
                <div class="mt-6">
                    ...
                    <a href="{{ route('edit-testimonial', $data['testimonial']->id) }}"
