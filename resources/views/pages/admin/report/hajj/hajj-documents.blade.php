            ...
            <div class="p-2">
                <div class="flex flex-col items-center justify-between pb-2 md:flex-row md:space-x-4">
                    <div class="w-full md:w-1/2">
                        <h1 class="mb-2 text-lg font-bold text-gray-900 dark:text-white">Export Dokumen Jamaah Haji</h1>
                    </div>
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center gap-4" method="GET" action="{{ route('report-hajj-documents') }}">
                            ...
                            @else
                                @foreach ($data['jamaah'] as $jamaah)
                                    <tr class="odd:bg-white even:bg-gray-50 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            <a href="{{ route('export-hajj-documents', $jamaah->id) }}" target="_blank"
